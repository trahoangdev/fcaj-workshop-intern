...
* Optimize **operations and cost** with Lambda-based EC2 start/stop automation and **Grafana** monitoring dashboards on EC2.

### Tasks to be carried out this week:
| Day | Task | Start Date | Completion Date | Reference Material |
| --- | ---- | ---------- | --------------- | ------------------ |
| 2 | - Practice **Tags & Resource Groups**: <br>&emsp; + Apply tags to EC2/S3 and other resources <br>&emsp; + Create a tag-based Resource Group <br>&emsp; + Use the group to manage and automate actions <br>&emsp; + Clean up resources | 18/05/2026 | 18/05/2026 | [Tags & Resource Groups](https://000027.awsstudygroup.com/) |
| 3 | - Practice **IAM tag-based access control for EC2**: <br>&emsp; + Create IAM policy with `Condition` on resource tags <br>&emsp; + Create IAM role for an EC2 Administrator persona <br>&emsp; + Validate least-privilege behavior <br> - Practice **IAM Permission Boundary**: <br>&emsp; + Create restriction policy as a boundary <br>&emsp; + Create a bounded IAM user <br>&emsp; + Verify the effective permissions and clean up | 19/05/2026 | 19/05/2026 | [IAM with Resource Tags](https://000028.awsstudygroup.com/) <br> [IAM Permission Boundary](https://000030.awsstudygroup.com/) |
| 4 | - Practice **Encrypt at rest with AWS KMS**: <br>&emsp; + Prepare IAM users/roles for the lab <br>&emsp; + Create a KMS Customer Managed Key (CMK) <br>&emsp; + Create an S3 bucket and enable SSE-KMS <br>&emsp; + Configure CloudTrail and query KMS events with Athena <br>&emsp; + Test sharing encrypted objects and clean up | 20/05/2026 | 20/05/2026 | [Encrypt at Rest with AWS KMS](https://000033.awsstudygroup.com/) |
| 5 | - Practice **AWS Security Hub**: <br>&emsp; + Review supported security standards <br>&emsp; + Enable Security Hub and integrations <br>&emsp; + Read the security score and findings by standard <br>&emsp; + Clean up resources | 21/05/2026 | 21/05/2026 | [AWS Security Hub](https://000018.awsstudygroup.com/) |
| 6 | - Practice **Optimize EC2 cost with Lambda**: <br>&emsp; + Tag instances by start/stop schedule <br>&emsp; + Create IAM role for Lambda <br>&emsp; + Author Lambda function and trigger via EventBridge <br>&emsp; + Verify start/stop and clean up <br> - Practice **Grafana basics on EC2**: <br>&emsp; + Provision a Linux EC2 instance <br>&emsp; + Install and configure Grafana <br>&emsp; + Add data source and build a dashboard to monitor resources <br>&emsp; + Clean up | 22/05/2026 | 22/05/2026 | [Optimize EC2 Cost with Lambda](https://000022.awsstudygroup.com/) <br> [Grafana Basic](https://000029.awsstudygroup.com/) |
