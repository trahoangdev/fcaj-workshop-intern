...
3. Sau khi bucket đã trống, chọn lại bucket -> Chọn **Delete** -> Nhập tên của bucket để xóa hoàn toàn bucket khỏi hệ thống.
...
3. Nhấn vào **Actions** ở góc trên -> Chọn **Delete API** -> xác nhận đồng ý xóa.
